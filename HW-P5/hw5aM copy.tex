...
\ctexset{
    ...
    section={   
        ...
        format=\ttfamily\raggedright\zihao{-4},%小四，左对齐，mono字体
        indent= {0.5em} %缩进
    },
    subsection={   
        name={另一个前面,另一个后面},
        number={\arabic{subsection}}, %如果只用一个数字而非1.1
        format=\rmfamily\mdseries\zihao{5},%正体字体，不加粗，main字体，五号字
        indent = {40pt}, %缩进
    ...
    subsubsection={   
        ...
        format=\sffamily\mdseries\zihao{5},%无衬线字体，不加粗，sans字体，五号字
        indent = {5em}, %缩进
